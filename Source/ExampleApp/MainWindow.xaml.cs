...
namespace ExampleApp {
	...
	public partial class MainWindow : Window {
		...
		private void ButtonB_Click(object sender, RoutedEventArgs e) {
			...
			// there is not a built in way to format number values
			// as ordinal strings (1st, 2nd 3rd)
			// note that ordinal abbreviations are culture dependent, 
			// this challenge assume English ordinals.
